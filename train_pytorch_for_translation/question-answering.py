"""
Adaptation of a Language Translation with nn.Transformer and torchtext, this 
model is oriented to solve a question-answer for emails
======================================================

This tutorial shows, how to train a translation model from scratch using
Transformer. We will be using http://jmcauley.ucsd.edu/data/amazon/qa/ 
grocery questions and answers.
"""
...
def yield_tokens(data_iter: Iterable) -> List:
